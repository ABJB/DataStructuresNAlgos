...
class driver{
    ...
    public static void main(String args[]){
        ...
        ArrayList<Integer> a = get_arrList();
        ArrayList<Integer> b = get_arrList();
        Collections.sort(a);
        Collections.sort(b);

        findMedianSorted Solver = new findMedianSorted();
        System.out.println(Solver.findMedianSortedArrays(a, b));
